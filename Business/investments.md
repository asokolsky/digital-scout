...
## Pooled/Index Investment Vehicles
...
- Invesco S&P 500 Momentum ETF, [SPMO](https://finance.yahoo.com/quote/SPMO/), focuses on the subset that 'has a high "momentum score"'
...
- Dow Jones Industrial Average ETF Trust, [DIA](https://finance.yahoo.com/quote/DIA/), known as "Diamonds," tracks the famous 30-stock Dow Jones Industrial Average.
...
| Fund                                                                                           | Expense Ratio |
| ---------------------------------------------------------------------------------------------- | ------------- |
| [SPDR](https://www.ssga.com/us/en/intermediary/etfs/spdr-sp-500-etf-trust-spy)                 | 0.0945%       |
| [VOO](https://investor.vanguard.com/investment-products/etfs/profile/voo#overview)             | 0.03%         |
| [SWPPX](https://www.schwab.com/research/mutual-funds/quotes/fees/swppx)                        | 0.02%         |
...
Here is a couple of usage scenarios.

#### To Hedge a Portfolio

Use options to protect against losses in stocks you own, much like buying insurance for your investments.

- Buying put options can limit your downside risk on a stock you own.

- For short sellers, call options can limit losses if the stock price moves against their position.

#### To generate income

Sell call options on stocks you already own (a strategy called a "covered call") to collect premium income.
